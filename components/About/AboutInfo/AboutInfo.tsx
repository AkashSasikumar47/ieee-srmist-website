    ...
    return (
        <section className="bg-black text-white py-16" style={{ width: '100%' }}>
            ...
            <div className="sm:hidden w-full px-4">
                <div className="text-center text-zinc-300 text-2xl font-semibold font-['Montserrat'] mb-8">Our Vision</div>
                ...
                <div className="text-center text-zinc-300 text-2xl font-semibold font-['Montserrat'] mb-8">Where are we based?</div>

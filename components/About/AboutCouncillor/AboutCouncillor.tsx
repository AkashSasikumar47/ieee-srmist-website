        ...
        <div>
            ...
            <section className="bg-black text-white py-16 hidden sm:block">
                <div className="w-[1440px] h-[640px] px-[84px] py-16 justify-center items-start gap-8 inline-flex">
                    ...
                    <img className="w-[400px] h-[512px] relative rounded-lg" src="https://via.placeholder.com/400x512" alt="Kylie Jenner" />
                    <div className="w-[400px] h-[512px] px-4 py-8 rounded-lg border border-white border-opacity-10 flex-col justify-center items-start gap-4 inline-flex">
            ...
            <section className="bg-black text-white py-8 block sm:hidden">
                <div className="w-full px-4">
                    ...
                    <img className="w-full h-[400px] object-cover rounded-lg mt-8" src="https://via.placeholder.com/400x512" alt="Kylie Jenner" />

        ...
        <div>
            ...
            <section className="bg-black text-white py-8 block sm:hidden">
                <div className="w-full px-4 flex flex-col justify-center items-center">
                    <div className="text-center text-blue-500 text-l font-bold font-montserrat">FAQ</div>
                    <div className="text-center text-gray-300 text-2xl font-bold font-montserrat mb-4">Frequently Asked Questions</div>

                    {/* Center the FAQ Cards */}
                    <div className="w-full max-w-screen-md mx-auto">
                        <div className="flex flex-col items-center space-y-4">
                            {/* FAQ Cards */}
                            <div className="w-full max-w-[400px] p-3 rounded-lg border border-white border-opacity-10 flex-col justify-center items-center">
                                <div className="text-white text-base font-semibold font-['Montserrat'] tracking-tight text-center">Q: How can I join IEEE SRM?</div>
                                <div className="text-white text-base font-normal font-['Montserrat'] text-center">A: You can join IEEE SRM by visiting our Membership page and following the instructions there.</div>
                            </div>
                            <div className="w-full max-w-[400px] p-3 rounded-lg border border-white border-opacity-10 flex-col justify-center items-center">

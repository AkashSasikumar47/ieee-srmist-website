...
const Hero = () => {
    return (
        <div className="bg-blue-100 bg-white pb-6 sm:pb-8 lg:pb-12">
            <div className="bg-red-100 mx-auto max-w-screen-2xl px-4 md:px-8">
                <header className="bg-green-100 mb-4 flex items-center justify-between py-10">
                    {/* logo - start */}
                    <a
                        href="/"
